...
public class EmailUtil {
	private static String fromEmail = "xy857802146@163.com";  // 发件人账号
	private static String fromEmailPw = "BHNVLQFLDNERUNBC";  // 发件人密码
	private static String myEmailSMTPHost = "smtp.163.com";  // 发件邮箱服务器
	...
	public static void main(String[] args) {
		try {
			instance.sendEmail("857802146@qq.com");
		} catch (Exception e) {
